...
-- commit sha: 423028b8e5e555664313cd44ee5193f75045c09e
...
(
    ...
    leader_id    bigint                  null                    comment '负责人主键',
    ...
    primary key (dept_id)
) engine=innodb auto_increment=100 comment = '部门';
...
(
    ...
    deleted          tinyint      default 0  not null                comment '逻辑删除',
    primary key (info_id)
) engine=innodb auto_increment=100 comment = '登录日志';
...
(
    ...
    deleted      tinyint      default 0   not null                comment '逻辑删除',
    primary key (menu_id)
) engine=innodb auto_increment=100 comment = '菜单';
...
) engine=innodb auto_increment=100 comment = '操作日志';
...
(
    ...
    deleted      tinyint    default 0   not null                comment '逻辑删除',
    primary key (post_id)
) engine=innodb auto_increment=100 comment = '岗位';
...
(
    ...
    primary key (role_id)
) engine=innodb auto_increment=100 comment = '角色';
...
(
    ...
    deleted      tinyint      default 0  not null                comment '删除标志（0代表存在 1代表删除）',
    primary key (user_id)
) engine=innodb auto_increment=100 comment = '用户';
